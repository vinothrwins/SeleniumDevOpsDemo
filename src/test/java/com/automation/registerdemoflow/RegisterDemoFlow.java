package com.automation.registerdemoflow;
...
public class RegisterDemoFlow {
	...
	String emailValue = "vinothrwins@gmail.com";
	String dODValue = "02/28/2025";
	...
	public void navigationToRegisterPage() {	 
	    ...
	    // Mouse hover coding is failing in the jenkins execution
		...
		WebElement registrationForm = driver.findElement(By.partialLinkText("Registration"));
	...
	public void registerUser() {	  
		...
		System.out.println("Verification succcessfull");
	...
	public void verifySuccessfulMessage() {	  
		...
		System.out.println("Successful message is verified Successfully");
	}
